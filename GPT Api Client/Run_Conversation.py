...
while True:
    ...
    conversation_generator = conversation_instance.add_to_conversation(prompt)

    #for chunk_content, finish_reason, created_local_time, token_cost_latest_message, token_cost_full_conversation, headline in conversation_generator:
    #    if headline != None:
    #        print("Headline:\n" + headline + "\n")
    #        print("Content: ")
    #    else:
    ...
    for chunk_content, finish_reason, created_local_time, token_cost_latest_message, token_cost_full_conversation in conversation_generator:
        print(chunk_content, end='')
    print()
    print()
